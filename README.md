...
<a href="https://en.wikipedia.org/wiki/Vim_(text_editor)"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Vimlogo.svg/1024px-Vimlogo.svg.png" width="300"/></a>



<table>
<tr><th>No:</th><th>Command (Click for Asciinema playback)</th><th>Description</th></tr>
<tr><td>1.</td><td><a href="https://echorand.me/posts/vim-notes/">Tips & Tricks</a></td><td>You can find the Manuel steps (bash script) of each steps involved in KochiOrgBook (KOB) Setup here</td></tr>
